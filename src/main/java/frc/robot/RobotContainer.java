...
import frc.robot.commands.DefaultLinearActuatorCommand;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    m_linearActuatorSubsystem.setDefaultCommand(new DefaultLinearActuatorCommand(m_linearActuatorSubsystem, () -> m_xboxController.getLeftX()));
